            ...
            <div className="w-4/12 h-full flex flex-col space-y-5 bg-white rounded-lg p-8 max-[1100px]:w-full ">
                ...
                <div className='flex flex-col justify-between items-center'>
                   ...
                   <div className='flex justify-between items-center space-x-5'>
                      <input className="w-7/12 p-3 focus-within:outline-none border border-gray-300 rounded-lg" placeholder='Kodunuz'/>
                      <div className='w-5/12 h-12 bg-zinc-700 text-white flex items-center justify-center cursor-pointer rounded-full hover:bg-black transform transition-colors duration-300'>Uygula</div>
                   </div>
                </div>
                <div className='h-[0.5px] w-full bg-gray-300'/>
