...
const Order = () => {
    ...
    return (
        <div className="w-5/12 p-10 bg-white rounded-xl space-y-5 max-[1100px]:w-full">
            ...
            {(normal.amountStandard !==0 || normal.amountSuper !==0  || normal.amountSuperPlus !==0 ) && <div className='p-5 border drop-shadow-md bg-white'>
                <h1>Ped Paketleri</h1>
            ...
            {(daily.amountDaily !==0 || daily.amountSuperDaily !==0) &&<div className='p-5 border drop-shadow-md bg-white'>
            ...
            {(tampon.amountMini !==0 || tampon.amountStandard !==0) &&<div className='p-5 border drop-shadow-md bg-white'>
